...
class admin_shopinfo extends ecjia_admin {
	...
	public function init() {
		...
		ecjia_screen::get_current_screen()->add_help_tab(array(
			'id'		=> 'overview',
			'title'		=> __('概述'),
			'content'	=> '<p>' . __('欢迎访问ECJia智能后台网店信息页面，系统中所有的网店信息都会显示在此列表中。') . '</p>'
		));
		
		ecjia_screen::get_current_screen()->set_help_sidebar(
			'<p><strong>' . __('更多信息：') . '</strong></p>' .
			'<p><a href="https://ecjia.com/wiki/帮助:ECJia智能后台:网店信息" target="_blank">'.__('关于网店信息帮助文档').'</a></p>'
		);
		
		$this->assign('ur_here', __('网店信息'));
		$this->assign('action_link', array('text' => __('添加网店信息'), 'href'=> RC_Uri::url('article/admin_shopinfo/add')));
	...
	public function add() {
		...
		ecjia_screen::get_current_screen()->add_help_tab(array(
			'id'		=> 'overview',
			'title'		=> __('概述'),
			'content'	=> '<p>' . __('欢迎访问ECJia智能后台添加网店信息页面，可以在此页面添加网店信息。') . '</p>'
		));
		
		ecjia_screen::get_current_screen()->set_help_sidebar(
			'<p><strong>' . __('更多信息：') . '</strong></p>' .
			'<p><a href="https://ecjia.com/wiki/帮助:ECJia智能后台:网店信息" target="_blank">'.__('关于添加网店信息帮助文档').'</a></p>'
		);
		
		$this->assign('ur_here', __('添加网店信息'));
		$this->assign('action_link', array('text' => __('网店信息'), 'href'=> RC_Uri::url('article/admin_shopinfo/init')));
	...
	public function insert() {
		...
		if ($is_only != 0) {
			return $this->showmessage(sprintf(__('网店标题 %s 已经存在'), stripslashes($title)), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_ERROR);
		}
		...
		return $this->showmessage(sprintf(__('添加 %s 成功'), stripslashes($title)), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('article/admin_shopinfo/edit', array('id' => $id))));
	}
	...
	public function edit() {
		...
		ecjia_screen::get_current_screen()->add_help_tab(array(
			'id'		=> 'overview',
			'title'		=> __('概述'),
			'content'	=> '<p>' . __('欢迎访问ECJia智能后台编辑网店信息页面，可以在此页面编辑相应的网店信息。') . '</p>'
		));
		
		ecjia_screen::get_current_screen()->set_help_sidebar(
			'<p><strong>' . __('更多信息：') . '</strong></p>' .
			'<p><a href="https://ecjia.com/wiki/帮助:ECJia智能后台:网店信息" target="_blank">'.__('关于编辑网店信息帮助文档').'</a></p>'
		);
		
		$this->assign('ur_here', __('编辑网店信息'));
		$this->assign('action_link', array('text' => __('网店信息'), 'href'=> RC_Uri::url('article/admin_shopinfo/init')));
	...
	public function update() {
		...
		$links = array('text' => __('返回网店信息列表'), 'href' => RC_Uri::url('article/admin_shopinfo/init'));
		return $this->showmessage(sprintf(__('更新 %s 成功'), stripslashes($title)), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('links' => $links, 'pjaxurl' => RC_Uri::url('article/admin_shopinfo/edit', array('id' => $id))));
	}
	...
	public function remove() {
		...
		$id = intval($_GET['id']);
		$shop_info = RC_DB::table('article')->where('article_id', $id)->first();
		...
		return $this->showmessage(sprintf(__('删除 %s 成功'), $shop_info['title']), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS);
	}
	...
	public function del_file() {
		...
		return $this->showmessage(__('删除成功'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('article/admin_shopinfo/edit', array('id' => $id))));
	}
