...
// 		_dump($data,1);
	...
	public function update() 
	{
		...
		if ($this->db_article->where(array('article_id' => $id))->update(
				array(
						'title'       => $title, 
						'content'     => $content, 
						'keywords'    => $keywords,
	...
	{
		$list = array();
		$data = $this->db_article->field('article_id, title , add_time')->where(array('cat_id' => $cat_id))->order('article_id asc')->select();
