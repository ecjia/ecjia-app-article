...
class admin_notice extends ecjia_admin {
	...
	public function insert() {
		...
		return $this->showmessage(sprintf(__('添加 %s 成功'), stripslashes($title)), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('article/admin_notice/edit', array('id' => $id))));
	}
	...
	public function update() {
		...
		return $this->showmessage(sprintf(__('更新 %s 成功'), stripslashes($title)), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('links' => $links, 'pjaxurl' => RC_Uri::url('article/admin_notice/edit', array('id' => $id))));
	}
	...
	public function remove() {
		...
		return $this->showmessage(sprintf(__('删除 %s 成功'), $info['title']), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS);
	}
	...
	public function del_file() {
		...
		return $this->showmessage(__('删除成功'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('article/admin_notice/edit', array('id' => $id))));
	}
