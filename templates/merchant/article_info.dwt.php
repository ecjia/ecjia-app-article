		...
		<section class="panel">
			<div class="panel-body panel-body-small">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a href="javascript:;" data-toggle="tab">{t}通用信息{/t}</a></li>
					<!--<li><a href="#tab2" data-toggle="tab">{t}文章内容{/t}</a></li>
					 -->
					<li><a class="data-pjax" href='{url path="article/merchant/link_goods" args="id={$smarty.get.id}"}'>{t}关联商品{/t}</a></li>
				</ul>
				{/if}
									...
									<div class="left-bar move-mod">
										...
										<div class="form-group m_t10">
											<div class="controls col-lg-11">
												<input type="text" name="title" class="span10 form-control" value="{$article.title|escape}" placeholder="{t}在此输入文章标题{/t}"/>
											</div>
											<span class="input-must"><span class="require-field" style="color:#FF0000,">*</span></span>
										</div>
										<div class="form-group m_b0">
											<label class="controls col-lg-11">{t}外部链接：{/t}</label>
											<div class="controls col-lg-11">
												<input type="text" name="link" class="span10 form-control" value="{if $article.link neq ''}{$article.link|escape}{else}http://{/if}"/>
												<div class="help-block">{t}若输入外部链接，则该链接优先{/t}</div>
											</div>
										</div>
										...
										<div class="panel-group" id="goods_info_sort_seo">
											<div class="panel panel-info">
												<div class="panel-heading">
													...
													<span class="glyphicon"></span>
													<h4 class="panel-title">{t}SEO优化{/t}</h4>
													</a>
												</div>
												<div class="accordion-body in collapse" id="goods_info_area_seo">
													<div class="panel-body">
														<div class="form-group m_b0">
															<label class="control-label col-lg-2 p_l0">{t}关键字：{/t}</label>
															<div class="col-lg-9 p_l0">
														...
														<div class="form-group m_b0">
															<label class="control-label col-lg-2 p_l0">{t}简单描述：{/t}</label>
															<div class="col-lg-9 p_l0">
										...
										<div class="panel-group" id="goods_info_sort_note">
											<div class="panel panel-info">
												<div class="panel-heading">
													...
													<span class="glyphicon"></span>
													<h4 class="panel-title"><strong>{t}自定义栏目{/t}</strong></h4>
													</a>
												</div>
												<div class="accordion-body in collapse" id="goods_info_term_meta">
													<div class="panel-body">
														...
														<tr>
															<td class="col-lg-6">
																...
																<div class="clear_both m_t5">
																	<a class="data-pjax btn btn-info m_t5" data-toggle="edit_term_meta" href="javascript:;">{t}更新{/t}</a>
																	<a class="ajaxremove btn btn-danger m_t5" data-toggle="ajaxremove" data-msg="{t}您确定要删除此条自定义栏目吗？{/t}" href='{url path="article/merchant/remove_term_meta" args="meta_id={$term_meta.meta_id}"}'>{t}移除{/t}</a>
																</div>
															</td>
															<td>
														...
														<!-- {/if} -->
														<!-- 编辑区域 -->
														<label class="control-label"><b>{t}添加自定义栏目：{/t}</b></label>
															...
															<tr>
																<td>
																	...
																	<div class="clear_both">
																		<a data-toggle="add_new_term_meta" href="javascript:;">{t}添加新栏目{/t}</a>
																	</div>
																	<!-- {else} -->
																	<input class="form-control" type="text" name="term_meta_key" value=""/>
																	<!-- {/if} -->
																	<a class="btn btn-primary m_t5" data-toggle="add_term_meta" href="javascript:;">{t}添加自定义栏目{/t}</a>
																</td>
																<td>
										...
										<div class="panel-group">
											<div class="panel panel-info">
												<div class="panel-heading">
													...
													<span class="glyphicon"></span>
													<h4 class="panel-title"><strong>{t}分类信息{/t}</strong></h4>
													</a>
												</div>
												<div class="panel-collapse collapse in" id="goods_info_area_cat">
													<div class="panel-body">
														<div class="form-group">
															<label class="control-label col-lg-4">{t}文章分类：{/t}</label>
														...
														<div class="form-group">
															<label class="control-label col-lg-4">{t}文章类型：{/t}</label>
															<div class="controls col-lg-8 p_l0">
														...
														<div class="form-group m_b0">
															<label class="control-label col-lg-6 m_l10">
																...
																<button class="btn btn-info" type="submit">{t}发布{/t}</button>
																{else}
																<button class="btn btn-info" type="submit">{t}更新{/t}</button>
																{/if}
															</label>
														</div>
													</div>
										...
										<div class="panel-group" id="goods_info_sort_upfile">
											<div class="panel panel-info">
												<div class="panel-heading">
													...
													<span class="glyphicon"></span>
													<h4 class="panel-title"><strong>{t}上传文件{/t}</strong></h4>
													</a>
												</div>
												<div class="accordion-body in in_visable collapse" id="goods_info_area_upfile">
													<div class="panel-body">
														<!-- {if $article.file_url neq ''} -->
														<span class="ecjiaf-db m_t5 m_b5 ecjiaf-wwb">{t}文件地址：{/t}</span>
														<span class="m_b10">{$article.file_url}</span>
														<a class="ajaxremove ecjiafc-red ecjiaf-db" data-toggle="ajaxremove" data-msg="{t}您确定要删除该文章附件吗？{/t}" href='{RC_Uri::url("article/merchant/drop_file","id={$article.article_id}&type=file_url")}'>
															{t}删除文件{/t}
														</a>
														<!-- {else} -->
						 								<div class="fileupload fileupload-new m_b0" data-provides="fileupload">
						                                    <span class="btn btn-primary btn-file btn-sm">
						                                        <span class="fileupload-new"><i class="fa fa-paper-clip"></i>{t}浏览{/t}</span>
										...
										<div class="panel-group" id="goods_info_sort_upfile">
											<div class="panel panel-info">
												<div class="panel-heading">
													<a class="accordion-toggle" data-toggle="collapse" data-target="#goods_info_area_upfile">
													<span class="glyphicon"></span>
													<h4 class="panel-title"><strong>{t}文章封面{/t}</strong></h4>
													</a>
												</div>
												<div class="accordion-body in in_visable collapse" id="goods_info_area_upfile">
													<div class="panel-body">
														<div class="fileupload fileupload-{if $article.cover_image}exists{else}new{/if} m_b0" data-provides="fileupload">
						                                    ...
						                                    <a class="btn btn-danger btn-sm fileupload-exists" {if $article.cover_image}data-toggle="ajaxremove" data-msg="{t}您确定要删除该图片吗？{/t}" {else}data-dismiss="fileupload"{/if} href='{RC_Uri::url("article/merchant/drop_file","id={$article.article_id}&type=cover_image")}'>{t}删除{/t}</a>
						                                </div>
													</div>
												</div>
											</div>
