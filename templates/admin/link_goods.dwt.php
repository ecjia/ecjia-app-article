	...
	<div class="span12">
		<div class="tabbable">
			<ul class="nav nav-tabs">
				<li><a class="data-pjax" href='{url path="article/admin/edit" args="id={$smarty.get.id}{if $publishby}&publishby={$publishby}{/if}"}#tab1'>{t}通用信息{/t}</a></li>
<!-- 				<li><a class="data-pjax" href='{url path="article/admin/edit" args="id={$smarty.get.id}"}#tab2'>{t}文章内容{/t}</a></li> -->
				...
				<div class="tab-content">
					<fieldset>
						<div class="control-group choose_list span12" data-url="{url path='article/admin/get_goods_list'}">
							<!-- <div class="f_l"> -->
								<select name="cat_id">
									<option value="0">{t}所有分类{/t}{$cat_list}</option>
								</select>
								<select name="brand_id">
									<option value="0">{t}所有品牌{/t}{html_options options=$brand_list}</option>
								</select>
							<!-- </div> -->
							<input type="text" name="keyword" />
							<a class="btn" data-toggle="searchGoods"><!-- {t}搜索{/t} --></a>
