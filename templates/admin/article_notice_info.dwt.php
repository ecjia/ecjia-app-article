		...
		<div class="tabbable">
			<form class="form-horizontal" action="{$form_action}" method="post" enctype="multipart/form-data" name="theForm">
				<div class="control-group formSep">
					<input type="text" name="title" size="40" maxlength="60" class="span10" value="{$article.title}" placeholder="{t}请输入文章标题{/t}"/> 
							...
							<div class="accordion-inner">
								<div class="control-group control-group-small m_t15">
									...
									<div class="controls">
										...
										<a class="ajaxremove ecjiafc-red ecjiaf-db" data-toggle="ajaxremove" data-msg="{t}您确定要删除该图片吗？{/t}" href='{RC_Uri::url("article/admin_notice/del_file", "id={$article.article_id}")}' title="{t}删除图片{/t}">
								        {t}删除图片{/t}
								        </a>
