			...
			<tbody>
				...
				<tr>
					<td class="hide-edit-area">
						...
						<div class="edit-list">
							<a class="ajaxremove ecjiafc-red no-underline" data-toggle="ajaxremove" data-msg="{lang key='article::shophelp.remove_cat_confirm'}" href='{RC_Uri::url("article/admin_shophelp/remove", "cat_id={$item.cat_id}")}' title="删除">删除</a>
				    	</div>
					</td>
					...
					<td align="center">
						<span>
							<a class="data-pjax no-underline" href='{RC_Uri::url("article/admin_shophelp/add", "cat_id={$item.cat_id}")}' title="添加帮助文章"><button class="btn" type="button" >添加文章</button></a>&nbsp;
							<a class="data-pjax no-underline" href='{RC_Uri::url("article/admin_shophelp/list_article", "cat_id={$item.cat_id}")}' title="查看帮助文章列表"><button class="btn" type="button" >查看列表</button></a>
						</span>
					</td>
				</tr>
				<!-- {foreachelse} -->
