...
class article_admin_menu_api extends Component_Event_Api {
    ...
    public function call(&$options) {
        $menus = ecjia_admin::make_admin_menu('07_content', RC_Lang::get('article::article.article_manage'), '', 5);
        ...
        $submenus = array(
        	...
        	ecjia_admin::make_admin_menu('02_article_add', RC_Lang::get('article::article.add_article'), RC_Uri::url('article/admin/add'), 2)->add_purview('article_manage'),
