...
class article_merchant_menu_api extends Component_Event_Api {
	public function call(&$options) {
		...
		$submenus = array(
			...
			ecjia_merchant::make_admin_menu('03_article_comment', __('文章评论列表'), RC_Uri::url('article/merchant/article_comment'), 3)->add_purview('mh_article_manage')->add_icon('fa-comments')
		);
